...
- **Cursor** = primary implementer for local iteration (run/debug, multi-monitor behavior, real file playback).
- **Jules** = async implementer for mechanical tasks while you do something else (docs, unit tests, small refactors).
...
- local implementation with quick feedback
- debugging and stepping through behavior
- safe, small edits in your working directory
